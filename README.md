...
Local development can use `VITE_AUTH_MODE=local` for browser-only auth. Auth, dashboard, report history, and settings also support API mode against the current backend read endpoints; see `frontend/README.md`.
