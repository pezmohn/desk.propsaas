...
`VITE_AUTH_MODE=api` uses the authenticated backend session and report read endpoints. Dashboard, settings, and admin surfaces stay in local read-model mode for now.
