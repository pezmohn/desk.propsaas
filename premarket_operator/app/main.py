    ...
    with SessionLocal() as session:
        try:
            ...
            return {
                ...
                "daily_report_id": str(result.daily_report_id) if result.daily_report_id else None,
                "outbound_telegram_message_id": (
                    str(result.outbound_telegram_message_id)
                    if result.outbound_telegram_message_id
                    else None
                ),
